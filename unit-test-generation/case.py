...
class Case:
    ...
    def __init__(self, cve_list: str, function_name:str, vulnerable_function_body: str, fixed_function_body: str, context: str = ""):
        ...
        self.harness_header_with_context = Case.harness_header.format(context=self.context)
    ...
    def get_replaceable_main_c(self, function_body, run_test_implementation: str) -> str:
        return Case.main_test_replace.format(function_signature=self.function_signature, function_body=function_body, run_test_implementation=run_test_implementation)
